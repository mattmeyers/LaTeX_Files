...
\begin{document}
	...
	\begin{figure}[!h]
		\begin{center}
			...
			\end{tikzpicture}
		\end{center}
		\caption{$K_2$} % Note the inclusion of the caption package and the caption command in the preamble, that command gets rid of the cpation labeling (it doesn't say fig 1 anymore)
	\end{figure}
